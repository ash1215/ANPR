...
def detectPlatesInScene(imgOriginalScene):
    ...
    if Main.showSteps == True:
        cv2.destroyAllWindows()
        cv2.imshow("Greyscale Image", imgGrayscaleScene)
        cv2.waitKey(0)

        cv2.destroyAllWindows()
        cv2.imshow("Thresholding Image", imgThreshScene)
        cv2.waitKey(0)
    ...
    if Main.showSteps == True: 
        ...
        #cv2.destroyAllWindows()
        #cv2.imshow("Countour Image", imgContours)
        #cv2.waitKey(0)
    ...
    if Main.showSteps == True: 
        ...
        # end for
        #cv2.destroyAllWindows()
        #cv2.imshow("Cpuntour Image 2", imgContours)
        #cv2.waitKey(0)
    ...
    if Main.showSteps == True:
        ...
        # end for
        cv2.destroyAllWindows()
        cv2.imshow("All Detected Contours in Image", imgContours)
        cv2.waitKey(0)
